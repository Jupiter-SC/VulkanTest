...
private:
    ...
    VkPipeline graphicsPipeline;                // YAAY
    std::vector<VkFramebuffer> swapChainFramebuffers;
    VkCommandPool commandPool;                  // Commands storage! Theyre all sent together. Multithreading capability apparently
    VkCommandBuffer commandBuffer;              // The actual commands
...
#pragma region Swap Chain
    ...
    void createSwapChain() {
        ...
        // I still dont really understand Queue Families
        QueueFamilyIndices indices = findQueueFamilies(physicalDevice);
...
#pragma endregion
    ...
    /// <summary>
    /// Stores framebuffer attachments
    /// </summary>
